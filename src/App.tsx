        ...
        <Router>
          ...
          <main className="container-app py-8">
            <Routes>
              ...
              {/* todo 관련 route */}
              <Route path="/todos" element={<TodoReadPage />}></Route>
              <Route path="/todos/read" element={<TodoReadPage />}></Route>
              <Route path="/todos/write" element={<TodoWritePage />}></Route>
              <Route path="/todos/:id" element={<TodoDetailPage />}></Route>
              <Route path="/todos/:id/edit" element={<TodoEditPage />}></Route>
              {/* todos 관련 route */}
              <Route path="/settings" element={<Settings />} />
              <Route path="*" element={<NotFound />} />
            </Routes>
          </main>
          <footer className="container-app py-8 text-neutral-500 dark:text-neutral-400">
            할일 앱 서비스 개발 @ 홍길동
          </footer>
        </Router>
      </TodoProvider>
